    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          {/* Colonna destra - Menu */}
          <div className="space-y-6">
            <h4 className="text-xs font-medium tracking-widest uppercase text-gray-300">
              MENU
            </h4>
        ...
        <div className="mt-16 pt-8">
          <h4 className="text-xs font-medium tracking-widest uppercase text-gray-300 mb-6">
            INSTAGRAM
          </h4>
          <a 
      ...
      {showScrollTop && (
        <button 
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 w-10 h-10 bg-gray-800 hover:bg-gray-700 border border-gray-600 text-white rounded transition-all duration-300 flex items-center justify-center z-50 opacity-0 animate-fade-in"
          style={{
