          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-600">055 845 6274</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex flex-col">
                  <span className="text-gray-600">+39 340 5043479</span>
                  <span className="text-gray-600">+39 349 604 4948</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-600">info@mengonidesign.it</span>
              </div>
            </div>
